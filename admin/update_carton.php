...
if (isset($title) && isset($img) && isset($video))
{
    ...
    $result=mysqli_query($db, "UPDATE carton SET title='$title',img='$img',video='$video' WHERE id='$id' ");
    if($result=='true'){
        echo"<p>Your cartoon succesfully updated !!!</p>";
    } 
    else{
        echo"<p>Your cartoon isn't updated </p>";
    }
