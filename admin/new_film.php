...
<section class="forwhom">
    <div class="container">
      ...
      <div class="row bg-warning ">
        ...
        <form name="form1" method="post" action="add_film.php">
      <div class="col-md-6 col-sm-12">
                    <label> Isert picture of film<br>
                    <input type="text" name="title" id="title">
                   </label>
                 </div>
                <div class="col-md-6 col-sm-12">
                    <label> Insert name of the film <br>
                    <input type="text" name="img" id="img">
                    </label>
                </div>
                <div class="col-md-6 col-sm-12">
                    <label> Isert video trailer of the film<br>
                    <input type="text" name="video" id="video">
                   </label>
                </div>
               
                
                <div class="col-md-6 col-sm-12 mt-2 mb-1">
