...
if(isset($_POST['video'])) {$video=$_POST['video'];    if($img=='') {unset($video);}             }
...
if (isset($title) && isset($img) && isset($video))
{
    ...
    $result=mysqli_query($db, "INSERT INTO carton(title,img,video) VALUES('$title','$img','$video')");
    if($result=='true'){
        echo"<p>Your film succesfully added !!!</p>";
    } 
    else{
        echo"<p>Your film isn't added </p>";
    }
